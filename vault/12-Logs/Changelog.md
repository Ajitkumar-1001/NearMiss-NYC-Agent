...
### Added
- [[PRD]] **v2.1.0-FINAL** installed, superseding v2.0.0 — the pre-event frozen
  revision (`pre_event_document_freeze: 2026-08-04`; no v2.2 planned). Change
  summary at [[PRD]] §1.2 and §1.3: Veris gets a conditional, non-runtime
...
- [[PRD]] **v2.0.0** installed, superseding v1.0.0. Adds the NYC Vision Hack v.2
...
- [[PRD]] v1.0.0 landed as the vault's canonical source of truth.
- `ADR-006-No-Identity-Recognition`, `ADR-007-FastAPI-Backend`,
  `ADR-008-Nextjs-Dashboard`, `ADR-009-Cloud-Run-Deployment`, and
  `ADR-010-JSON-Fixture-Fallbacks` — the five [[PRD]] §27 locked decisions that
  had no ADR.
- [[PRD]] **v2.0.0** import, full change summary at [[PRD]] §1.1: Google Cloud
  ...
  [[PRD]] §29 (up from v1's 10), four are new and have no ADR yet:
...
### Removed
- **`07-Decisions/` and all ten ADRs, revoked.** [[PRD]] v2.0.0 §29 now holds
  ...
  Inbound wikilinks across the vault were repointed to [[PRD]] §29.
