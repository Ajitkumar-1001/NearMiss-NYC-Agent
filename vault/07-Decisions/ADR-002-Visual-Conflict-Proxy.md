...
calibration, which [[PRD]] §25 lists as a prohibited time sink before P0, and
...
- Precision and recall are unmeasured; a high score may not be a real near-miss,
  which [[PRD]] §8 concedes explicitly.
...
- Metric rigour is given up for something that ships, explains itself, and does
  not overclaim. Calibrated geometry is R1 work ([[PRD]] §28).
...
---
Related: [[PRD]] · [[05-Safety-Methodology]] · [[04-Computer-Vision-Notes]] · [[04-Vision-Evaluation]] · [[10-Responsible-AI]] · [[00-ADR-Index]]
