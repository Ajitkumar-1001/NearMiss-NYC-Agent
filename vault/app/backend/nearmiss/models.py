...
# FR-012. Exactly one is active per report. Wire values are snake_case; the UI
# renders them title-case ("Demonstration replay").
ProcessingMode = Literal["live_feed", "runtime_analysis", "demonstration_replay"]
...
class Health(Strict):
    """FR-015. `GET /health` must return 200 with version and dependency state."""
