...
> [!info] Source
> [[00-Source-of-Truth-PRD|PRD]] §11.1 (P0) and §14 (functional requirements). P1 and P2 are
...
([[00-Source-of-Truth-PRD|PRD]] §11.1): Cloud Run and public access, the real-feed path, the
...
([[00-Source-of-Truth-PRD|PRD]] §3, §10 principle 2).

### Cloud Run and public access

| # | Capability | Why it's essential | Owner | Status |
|---|---|---|---|---|
| 1 | Public FastAPI agent deployed on Google Cloud Run, listening on `0.0.0.0:$PORT` | Hard eligibility gate — the submission is not hackathon-complete without it ([[00-Source-of-Truth-PRD|PRD]] §2.2, NFR-001) | Ajit | todo |
| 2 | Health endpoint — `GET /health` returns HTTP 200 (FR-019) | Proves the deployment is alive before the demo starts | Ajit | todo |
| 3 | Public access verified from a logged-out browser or independent device; known-good deployed revision preserved and identifiable | Judges need a working public URL with no auth barrier ([[00-Source-of-Truth-PRD|PRD]] §2.2, NFR-002) | Ajit | todo |

### Real-feed path

| # | Capability | Why it's essential | Owner | Status |
|---|---|---|---|---|
| 4 | One configured NYC source from the approved source policy, retrieved through a source adapter (FR-001, FR-002; [[00-Source-of-Truth-PRD|PRD]] §18) | Real-feed analysis is now P0, not an enhancement | Ajit | todo |
...
| 7 | Annotated result returned through the Cloud Run service (FR-012) | The five-second comprehension test in [[00-Source-of-Truth-PRD|PRD]] §12.3 applies to the live path too | Ajit | todo |
| 8 | Valid `no_candidate_conflict` / `insufficient_temporal_evidence` outcome supported (FR-008, FR-017) | A live no-conflict or insufficient-evidence result is a valid, locked outcome — never a fabricated alert ([[00-Source-of-Truth-PRD|PRD]] §29) | Ajit | todo |
...
| 12 | Annotated replay — boxes, trails, conflict marker (FR-012) | The five-second comprehension test in [[00-Source-of-Truth-PRD|PRD]] §12.3 | Ajit | todo |
| 13 | Visual conflict-risk proxy with factor breakdown (FR-010) | Explainability; an opaque score fails the evidence-before-narration principle in [[00-Source-of-Truth-PRD|PRD]] §10 (principle 3) | Ajit | todo |
...
| # | Capability | Why it's essential | Owner | Status |
|---|---|---|---|---|
| 17 | Public repository with a permissive license | Open Source is a judging dimension ([[00-Source-of-Truth-PRD|PRD]] §2.3) | Ajit | todo |
...
listed in [[00-Source-of-Truth-PRD|PRD]] §13; the first implementation prioritises one of them based on
the selected clip.
...
---
Related: [[00-Source-of-Truth-PRD|PRD]] · [[05-Non-Goals]] · [[03-Scope-Ladder]] · [[08-Definition-of-Done]] · [[07-Demo-Story]]
