...
> [!info] Source
> [[00-Source-of-Truth-PRD|PRD]] §20 (core data contract), plus FR-003 (provenance and freshness),
...
- **Persistence needed?** No. A persistent user database is an explicit non-goal
  ([[00-Source-of-Truth-PRD|PRD]] §9). PRD v2.0 §27 (execution plan) replaced v1's prohibited-time-sinks
...
fallbacks, not test data — [[00-Source-of-Truth-PRD|PRD]] §29.

---
Related: [[00-Source-of-Truth-PRD|PRD]] §29 · [[05-API-Contracts]] · [[03-Data-Flow]] · [[10-Responsible-AI]]
